...
namespace Csharp
{
    public class ParallelSort
    {
        ...
        public ParallelSort(int valuesCount, DataType dataType)
        {
        ...
        public int[] start()
        {
            Parallel.ForEach(Partitioner.Create(0, valuesCount, valuesCount / 8),
                range =>
                {
                    serialEnumSort(valuesCount, range.Item1, range.Item2);
                });
